            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <div className="relative flex items-center" onMouseLeave={() => {
                ...
                >
                      ...
                      <Link to="/GeoDataViz" className="block px-4 py-2 text-sm hover:bg-secondary-50 dark:hover:bg-secondary-800 text-secondary-900 dark:text-white transition-colors" role="menuitem" onClick={() => setProjectsDropdownVisible(false)}>Geospatial DataViz</Link>
                      <a href="https://lilt-app.vercel.app" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-secondary-50 dark:hover:bg-secondary-800 text-secondary-900 dark:text-white rounded-b-lg transition-colors" role="menuitem" onClick={() => setProjectsDropdownVisible(false)}><img src="/images/lilt-icon.svg" alt="" className="w-4 h-4 rounded" /> Lilt <span className="ml-auto text-secondary-400" aria-hidden="true">↗</span></a>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
              ...
              >
                ...
                {projectsDropdownVisible && (
                  <div className="ml-2 mt-1 bg-white dark:bg-secondary-900 rounded-lg shadow border border-secondary-100 dark:border-secondary-700 flex flex-col">
                    ...
                    <Link to="/GeoDataViz" className="block px-4 py-3 text-base hover:bg-secondary-50 dark:hover:bg-secondary-800 text-secondary-900 dark:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary-400" onClick={() => { setIsMenuOpen(false); setProjectsDropdownVisible(false); }}><FaProjectDiagram className="inline mr-2 w-4 h-4" /> Geospatial DataViz</Link>
                    <a href="https://lilt-app.vercel.app" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-3 text-base hover:bg-secondary-50 dark:hover:bg-secondary-800 text-secondary-900 dark:text-white rounded-b-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary-400" onClick={() => { setIsMenuOpen(false); setProjectsDropdownVisible(false); }}><img src="/images/lilt-icon.svg" alt="" className="mr-2 w-4 h-4 rounded" /> Lilt <span className="ml-auto text-secondary-400" aria-hidden="true">↗</span></a>
                  </div>
                )}
